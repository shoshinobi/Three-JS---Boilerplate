...
export default class Environment {
  ...
  setSunLight() {
    this.sunLight = new THREE.DirectionalLight("#ecb78b", 0.8);
  ...
  setEnvironmentMap() {
    ...
    // this.environmentMap.texture.colorSpace = THREE.RGBEColorSpace

    this.environment = this.environmentMap.texture;
